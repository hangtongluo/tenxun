# -*- coding: utf-8 -*-
"""
Created on Fri May 12 13:19:21 2017
...
def process_train_test_data():
    ...
    ad = pd.read_csv(r'F:\data\tenxun\data\ad_process.csv', low_memory=False) 
...
#    app_categories_process = pd.read_csv(r'F:\data\tenxun\data\app_categories_process.csv', low_memory=False) 
    position = pd.read_csv(r'F:\data\tenxun\pre\position_process.csv', low_memory=False) 
    user = pd.read_csv(r'F:\data\tenxun\data\user_process.csv', low_memory=False) 
